...
class Contador{
    ...
    */
    ...
    public String toString(){  //toString retorna String contendo as quantidades de cada informação pedida no enunciado
        return "a(" + this.a[0] + ") " +  
        "e(" + this.e[0] + ") " + 
        "i(" + this.i[0] + ") " + 
        "o(" + this.o[0] + ") " + 
...
class App {
    ...
    /*
        getHtml retorna o contéudo HTML de um url em String
    */
    ...
    /*
        isUpper verifica se caracter é uma letra maiúscula
    */
    ...
    /*
       isLower verifica se caracter é uma letra minúscula
    */
    ...
    /*
        isLetter verifica se caracter é uma letra do alfabeto
    */
    ...
    /*
        isVowel verifica se caracter é uma vogal
    */
    ...
    /*
        isConsonant verifica se caracter é uma consoante minúscula.
    */
    ...
    /*
        isBr verifica se String é igual a "<br>"
    */
    ...
    /*
        isTable verifica se String é igual a "<table>"
    */
    ...
    /*
        contar conta os elementos pedidos da Questão. Ex: Vogais, consoantes, <tables>...
    */
    ...
    /*
        isFim verifica se String do parametro é igual a "FIM"
    */
