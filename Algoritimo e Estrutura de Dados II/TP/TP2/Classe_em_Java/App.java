...
public class App {
    ...
    //revisar orientacao objeto
    
    public static Personagem getCSV(){
        String str = "";
        try{
        ...
        Personagem p = new Personagem(str);
        return p;
    }
    public static void main(String[] args){
        String csvLine = getCSV().toString();
        MyIO.println(csvLine);
...
class Personagem {
    ...
    Personagem(String info){
        setPersonagem(info);
    }
    
    public String setPersonagem(String csvLine){
        
        String split = csvLine;//.split(",");
        MyIO.println(split);
        // for(int i = 0; i <= csvLine.length(); i++){
        //     MyIO.println(split[i]);
        // }
        return split;
    }
